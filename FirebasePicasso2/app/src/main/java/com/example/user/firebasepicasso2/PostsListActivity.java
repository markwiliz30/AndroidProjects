...
public class PostsListActivity extends AppCompatActivity {
    ...
    private void firebaseSearch(String searchText){
        ...
        //convert string in SearchView to lowercase
                    ...
                    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType){
                        ...
                        viewHolder.setOnClickListener(new ViewHolder.ClickListener() {
                            ...
                            public void onItemLongClick(View view, int position) {
                                //TODO do your own implementation on ling item click
                            }
                        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.action_add){
            ...
            startActivity(new Intent(PostsListActivity.this, PostDetailActivity.class));
            return true;
        }
                ...
                .setItems(sortOptions, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (which==0){
                            ...
                            editor.putString("Sort", "newest"); //where 'Sort' is a key & 'newest' is value
                            ...
                            //Edit our shared preferences
                            SharedPreferences.Editor editor = mSharedPref.edit();
                            editor.putString("Sort", "oldest"); //where 'Sort' is a key & 'oldest' is value
                            editor.apply(); //apply/save the value in our shared preference
                            recreate(); //restart activity to take effect
                        }
                    }
